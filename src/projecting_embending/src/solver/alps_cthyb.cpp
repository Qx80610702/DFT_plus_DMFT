              ...
              for(int is2=0; is2<2; is2++)
              {
                if(is1!=is2)
                  ...
                  if(nspin==1)
                    ...
                    << std::setw(4) << count1 << std::setw(4) << count2
                    << std::setw(22) << std::fixed << std::setprecision(15) 
                    << std::pow(Hartree_to_eV,2)*hyb_taua[0][itau][m1*m_tot+m2].real() << " "
                    << std::setw(20) << std::fixed << std::setprecision(15) 
                    << std::pow(Hartree_to_eV,2)*hyb_taua[0][itau][m1*m_tot+m2].imag() << '\n';
                  else
                    ofs_delta << std::left << std::setw(5) << itau 
                    << std::setw(4) << count1 << std::setw(4) << count2
                    << std::setw(22) << std::fixed << std::setprecision(15) 
                    << std::pow(Hartree_to_eV,2)*hyb_taua[is1][itau][m1*m_tot+m2].real() << " "
                    << std::setw(22) << std::fixed << std::setprecision(15) 
                    << std::pow(Hartree_to_eV,2)*hyb_taua[is1][itau][m1*m_tot+m2].imag() << '\n';
              ...
              if(is1!=is2)
                ...
                if(nspin==1)
                  if(count1==count2)
                    ofs_hopping << std::setw(4) << count1 << std::setw(4) << count2
                    << std::setw(22) << std::fixed << std::setprecision(15) 
                    << Hartree_to_eV*(hoppinga[0][m1*m_tot+m2].real() - mu) << " "
                    << std::setw(22) << std::fixed << std::setprecision(15) 
                    << Hartree_to_eV*hoppinga[0][m1*m_tot+m2].imag() << '\n';
                  else
                    ofs_hopping << std::setw(4) << count1 << std::setw(4) << count2
                    << std::setw(22) << std::fixed << std::setprecision(15) 
                    << zero << " "
                  ...
                  if(count1==count2)
                    ofs_hopping << std::setw(4) << count1 << std::setw(4) << count2
                    << std::setw(22) << std::fixed << std::setprecision(15) 
                    << Hartree_to_eV*(hoppinga[is1][m1*m_tot+m2].real() - mu) << " "
                    << std::setw(22) << std::fixed << std::setprecision(15) 
                    << Hartree_to_eV*hoppinga[is1][m1*m_tot+m2].imag() << '\n';
                  else
                    ofs_hopping << std::setw(4) << count1 << std::setw(4) << count2
                    << std::setw(22) << std::fixed << std::setprecision(15) 
                    << zero << " "
          ...
          for(int m_index=0; m_index<m_tot*m_tot; m_index++)
          {
            ...
            if(nspin==1)
              ofs_Weiss << std::left << std::setw(5) << iomega << std::setw(2) << is 
                  << std::setw(3) << m1 << std::setw(3) << m2
                  << std::setw(22) << std::fixed << std::setprecision(15) 
                  << Weissa[0][iomega][m_index].real()/Hartree_to_eV << " "
                  << std::setw(20) << std::fixed << std::setprecision(15) 
                  << Weissa[0][iomega][m_index].imag()/Hartree_to_eV << " " << '\n';
            else
              ofs_Weiss << std::left << std::setw(5) << iomega << std::setw(2) << is 
                  << std::setw(3) << m1 << std::setw(3) << m2
                  << std::setw(22) << std::fixed << std::setprecision(15) 
                  << Weissa[is][iomega][m_index].real()/Hartree_to_eV << " "
                  << std::setw(22) << std::fixed << std::setprecision(15) 
                  << Weissa[is][iomega][m_index].imag()/Hartree_to_eV << " " << '\n';
          ...
          for(int m_index=0; m_index<m_tot*m_tot; m_index++)
          {
            ...
            if(nspin==1)
              ofs_hyb << std::left << std::setw(5) << iomega << std::setw(2) << is 
                  << std::setw(3) << m1 << std::setw(3) << m2
                  << std::setw(22) << std::fixed << std::setprecision(15) 
                  << hyb_omegaa[0][iomega][m_index].real()*Hartree_to_eV << " "
                  << std::setw(22) << std::fixed << std::setprecision(15) 
                  << hyb_omegaa[0][iomega][m_index].imag()*Hartree_to_eV << '\n';
            else
              ofs_hyb << std::left << std::setw(5) << iomega << std::setw(2) << is 
                  << std::setw(3) << m1 << std::setw(3) << m2
                  << std::setw(22) << std::fixed << std::setprecision(15) 
                  << hyb_omegaa[is][iomega][m_index].real()*Hartree_to_eV << " "
                  << std::setw(22) << std::fixed << std::setprecision(15) 
                  << hyb_omegaa[is][iomega][m_index].imag()*Hartree_to_eV << '\n';
          }//m_index
        }//iomega
      }//is
      ofs_hyb.close();
          ...
          std::complex<double>>>>>& Gf_save)
  {
    ...
    for(int ineq=0; ineq<ineq_num; ineq++)
    {
      ...
      while(ifs_gf.good())
      {
        ...
        if(ispin1==ispin2)
          if(nspin==2)
            Gf_qmca[ispin1][iomega][m1*m_tot+m2] = Hartree_to_eV*std::complex<double>(real,imag);
      ...
      while(ifs_gfsave.good())
      {
        ...
        if(nspin==2)
          Gf_savea[ispin1][iomega][m1*m_tot+m2] = Hartree_to_eV*std::complex<double>(real,imag);
        else if(nspin==1 && ispin1==0)
          Gf_savea[ispin1][iomega][m1*m_tot+m2] = Hartree_to_eV*std::complex<double>(real,imag);
      ...
      if (!ifs_Weiss)  
	    {
	    	std::cout << "Fail to oepn " << Weiss_file.c_str() << std::endl;
        std::exit(EXIT_FAILURE);
      }
      ...
      while(ifs_Weiss.good())
      {
        ...
        {
          if(nspin==2)
            Weissa[ispin1][iomega][m1*m_tot+m2] = Hartree_to_eV*std::complex<double>(real,imag);
          else if(nspin==1 && ispin1==0)
            Weissa[ispin1][iomega][m1*m_tot+m2] = Hartree_to_eV*std::complex<double>(real,imag);
        }
          ...
          for(int m_index=0; m_index<m_tot*m_tot; m_index++)
          {
            ...
            if(nspin==1)
              ofs_sig << std::left << std::setw(5) << iomega << std::setw(2) << is 
                  ...
                  << sigma_a[0][iomega][m_index].real()*Hartree_to_eV << " "
                  << std::setw(20) << std::fixed << std::setprecision(12) 
                  << sigma_a[0][iomega][m_index].imag()*Hartree_to_eV << '\n';
            else
              ofs_sig << std::left << std::setw(5) << iomega << std::setw(2) << is 
                  << std::setw(3) << m1 << std::setw(3) << m2
                  << std::setw(20) << std::fixed << std::setprecision(12) 
                  << sigma_a[is][iomega][m_index].real()*Hartree_to_eV << " "
                  << std::setw(20) << std::fixed << std::setprecision(12) 
                  << sigma_a[is][iomega][m_index].imag()*Hartree_to_eV << '\n';
          }//m_index
        }//iomega
      }//is
      ofs_sig.close();
