              ...
              if(is1!=is2)
                ...
                else
                {
                  ofs << std::left << std::setw(6) << count 
                    ...
                    << std::setw(3) << count2 << std::setw(3) << count1
                    << std::setw(20) << std::fixed << std::setprecision(12) 
                    << Hartree_to_eV*(atom.Uval(iatom)-2*atom.Jval(iatom))
                    << std::setw(20) << std::fixed << std::setprecision(12) << zero << '\n';
                  count++;
                }
              else
                if(m1!=m2)
                {
                  ofs << std::left << std::setw(6) << count 
                    ...
                    << std::setw(3) << count2 << std::setw(3) << count1
                    << std::setw(20) << std::fixed << std::setprecision(12) 
                    << Hartree_to_eV*(atom.Uval(iatom)-3*atom.Jval(iatom))
                    << std::setw(20) << std::fixed << std::setprecision(12) << zero << '\n';
                    count++;
                }
              count2++;
            ...
            for(int is2=0; is2<2; is2++)
            {
              if(is1==is2)
              {
                if(m1==m2)
                  ...
                  ofs << std::left << std::setw(10) << std::fixed 
                      << std::setprecision(6) << Hartree_to_eV*
              ...
              else
              {
                if(m1==m2)
                  ofs << std::left << std::setw(10) << std::fixed 
                      << std::setprecision(6) << Hartree_to_eV*atom.Uval(iatom);
                else
                  ofs << std::left << std::setw(10) << std::fixed 
                      << std::setprecision(6) << Hartree_to_eV*
