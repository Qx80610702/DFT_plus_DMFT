...
namespace DFT_plus_DMFT
{
        ...
        DFT_output::atoms_info& atom )
  {
    ...
    GlobalV::ofs_running << "Impurity solver starts working......" << std::endl;
        ...
        const int DMFT_step)
  {
    ...
    GlobalV::ofs_running << "\nSelf-consistency of self-energy in charge step" 
              << std::setw(4) << charge_step 
              << "  dmft step" << std::setw(4) << DMFT_step 
              << " : false\n";
      
    GlobalV::ofs_running << "    impuritys            Delta_Sigma\n";
